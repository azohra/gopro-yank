...
:root{color-scheme:light dark;--bg:#091015;--panel:#111c23;--line:#29404d;--text:#edf7fa;--muted:#9ab0ba;--cyan:#42d3e8;--green:#62d995;--amber:#ffc857}*{box-sizing:border-box}body{margin:0;font:15px/1.5 ui-monospace,SFMono-Regular,Menlo,monospace;background:var(--bg);color:var(--text)}main{width:min(1100px,calc(100% - 32px));margin:48px auto 80px}h1{font-size:clamp(2.2rem,7vw,4.8rem);letter-spacing:-.04em;margin:.2rem 0}.muted{color:var(--muted)}.verdict{margin:28px 0;padding:22px;border:1px solid var(--line);border-left:6px solid var(--amber);background:var(--panel);border-radius:10px}.verdict.good{border-left-color:var(--green)}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px;margin:24px 0}.metric,.card{border:1px solid var(--line);background:var(--panel);border-radius:10px;padding:18px}.metric strong{display:block;font-size:1.65rem;color:var(--cyan)}.two{display:grid;grid-template-columns:repeat(auto-fit,minmax(310px,1fr));gap:16px;margin:16px 0}table{width:100%;border-collapse:collapse}th,td{padding:9px 8px;text-align:left;border-bottom:1px solid var(--line);vertical-align:top}th{color:var(--muted)}code{color:var(--cyan);word-break:break-all}.status{color:var(--amber)}footer{margin-top:32px;color:var(--muted)}</style></head><body><main>
<div class="muted">GOPRO YANK · VERIFIED ARCHIVE</div><h1>Your media, back home.</h1><p class="muted">Portable report generated from <code>.gopro-yank/manifest.json</code>.</p>
