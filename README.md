...
2. It reads your library and shows what is already archived, what can download,
   and what still needs a manual export.
...
By default, GoPro Yank uses `Pictures/GoPro` on macOS and Windows. You can choose
a local folder or mounted external drive before archiving.
...
| `gopro-yank login` | Connect on a computer without the interactive app |
